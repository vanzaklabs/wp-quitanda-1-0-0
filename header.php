    ...
    <div class="announcement-bar bg-02 d-flex justify-center align-center" id="announcement-bar">
        <div class="container">
            <div class="d-flex justify-announ align-center">
                <p id="p-anbar" class="text-black">RUA MATEUS GROU, 159 - PINHEIROS</p>
                <p id="p-anbar" class="text-black d-none-mobile">SEGUNDA A SEXTA 7H - 22H • SÁBADO E DOMINGO 7H - 21H • FERIADOS 7H -
                    21h</p>
